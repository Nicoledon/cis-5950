...
TEST_CASE("basic erase", "[erase]") {
  ...
  preallocated.push_back("alpha");
  preallocated.push_back("beta");
  preallocated.push_back("gamma");
  REQUIRE(preallocated.capacity() == 5);
...
TEST_CASE("complex erase", "[erase]") {
  ...
  for (int i = 0; i < 10; ++i) {
    v2.push_back("EdgeItem" + std::to_string(i));
  }
  REQUIRE(v2.length() == 10);
  ...
  for (int i = 0; i < 600; ++i) {
    v3.push_back("Item" + std::to_string(i));
  }
...
TEST_CASE("complex reserve", "[reserve]") {
  ...
  v.push_back("alarm");
  v.push_back("tree");
  v.push_back("very big tree");
  v.push_back(" ");
  v.push_back("fish with eyes");
